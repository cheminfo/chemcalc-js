...
function Xu(a){Ms.call(this,a)}
function iv(a){yb.call(this,a)}
...
function ru(a){return a.a.e*a.a.c}
function su(a){return a.a.e*a.a.d}
...
function qv(a){a.b=a.d.b;a.c=new bu}
...
function Iu(a,b,c){Ju.call(this,a,b,c,true)}
...
function Vu(a,b,c){Wu.call(this,a,b,c,1,true)}
function mu(a,b,c,d){lu.call(this,a,0,b,c,d)}
...
function Tv(){return Qv(Vv(new xq,hv(null),(gv(),gv(),ev)))}
...
function ov(a){if(a.e.c.d==0)throw Xg(new Ab(yx));return au(a.e.c)}
function nv(a){if(a.e.c.d==0)throw Xg(new Ab(yx));return _t(a.e.c)}
...
function iw(a,b){return b==null?hw(a,Ox,(Pc(),Pc(),Oc)):hw(a,Ox,new Uc((ht(b),b)))}
...
function lu(a,b,c,d,e){this.b=new xq;this.c=a;this.d=b;this.g=c;this.e=d;this.a=e}
function Gt(a,b,c,d){if(c>d)throw Xg(new iv(fx));this.i=a;this.b=b;this.d=c;this.c=d}
function Qv(a){if(Ax in a.a.a){throw Xg(new Fb(_c(a.a,Ax).B().a))}else{return a.a.a}}
...
function tv(a,b){if(a.d.f==0){return uv(a,b)}else if(a.d.f==1){return vv(a,b)}return uv(a,b)}
...
function Rv(a,b){var c;c=Sv(b);Rq(c.b,wx,a);return Qv(Wv(c,hv(c.b.a.get(Bx)),(gv(),gv(),ev)))}
function Uv(a,b){var c;c=Sv(b);Rq(c.b,jx,''+a);return Qv(Zv(c,hv(c.b.a.get(Bx)),(gv(),gv(),ev)))}
...
function St(a,b){var c,d,e;c=(new ps(a)).b.V();while(_n(c.a)){d=c.b=ao(c.a);e=nt(d.T());e<b&&js(c)}}
function wv(a,b,c,d){St(a.c,d);switch(a.d.f){case 0:Qt(a.c,c);break;case 1:Rt(a.c,c);}Wt(a.c,b)}
...
function Eu(b){try{Bi(b);return true}catch(a){a=Wg(a);if(we(a,21)){return false}else throw Xg(a)}}
...
function Av(a,b,c){this.d=a;qv(this);this.a=c;sv(this,b);if(b.a!=0){Pt(this.c,-b.a*zx);Ut(this.c,1/$i(b.a))}}
...
function lv(a){var b,c,d;b=hx;for(d=new bq(a.d.d);d.a<d.c.a.length;){c=aq(d);c.f>b&&(b=c.f)}wv(a.e,b,a.b,a.a)}
...
function Vt(a,b){var c,d,e,f;c=(new ps(a)).b.V();while(_n(c.a)){d=c.b=ao(c.a);e=d.S();f=d.T();Tr(a,e,(ht(f),f)*b)}}
...
function jv(a,b,c){var d,e,f;f=Nv(ov(a),b,c);e=new bu;for(d=0;d<f.length;d++){Tr(e,f[d][0],f[d][1])}a.e.c=e;a.e.c.a=Sw}
function Rq(a,b,c){var d;d=a.a.get(b);a.a.set(b,c===undefined?null:c);if(d===undefined){++a.c;tq(a.b)}else{++a.d}return d}
function Yt(a){var b,c;b=new jk(a);c=ik(fk(b,(Zl(),Zl(),Wl)));if(c.indexOf('.')!=-1){return vj(c,'\\.?0+$','')}return c}
...
function iu(a){if(a.d==0)throw Xg(new Ab('Exact mass of '+a.g+' is unknown. Run calculateExactMass() first.'));return a.d}
...
function Jt(a,b,c){if(b>c)throw Xg(new iv(fx));this.d=b;this.c=c;this.e=Qu(a.a);this.f=Ru(a.a);this.a=0;this.i=a.b;this.b=Pu(a.a)}
...
function Ou(a,b){var c,d,e,f;for(d=(f=(new jp(a.g)).a.N().b.V(),new pp(f));_n(d.a.a);){c=(e=is(d.a),e.S());if(oj(c.i,b))return c}return null}
function Pt(a,b){var c,d,e,f,g;d=new bu;c=(new ps(a)).b.V();while(_n(c.a)){e=c.b=ao(c.a);f=e.S();g=e.T();Tr(d,(ht(f),f)+b,g);js(c)}Ot(a,d)}
function Ut(a,b){var c,d,e,f,g;d=new bu;c=(new ps(a)).b.V();while(_n(c.a)){e=c.b=ao(c.a);f=e.S();g=e.T();Tr(d,(ht(f),f)*b,g);js(c)}Ot(a,d)}
function Tt(a){var b,c,d,e,f,g;b=hx;f=0;c=(new ps(a)).b.V();while(_n(c.a)){d=c.b=ao(c.a);e=d.S();g=nt(d.T());if(g>b){b=g;f=(ht(e),e)}}return f}
...
function tu(a,b,c,d,e,f){a.d=_i(De($wnd.Math.floor((c-f-b-e)/a.a.e)),a.a.d);a.c=aj(De($wnd.Math.ceil((c+f-b-d)/a.a.e)),a.a.c);a.b=a.d-1}
...
function Ju(a,b,c,d){this.a=b;this.b=c;this.d=new Jp;Fu(this,a,d);if(this.d.a.length==0)throw Xg(new iv('Cannot parse: empty formula: ->'+a+'<-'))}
...
function yu(a){var b,c,d,e,f;c='';b=new km;d=em(b,bt((f=a,Zs(),f)));for(e=0;e<5;e++){e==0?(c+=ue($i(d[0]%26)+65&Dw)):(c+=ue($i(d[e]%26)+97&Dw))}return c}
...
function Nu(a){var b,c,d,e,f,g;f=Pu(a);for(c=(e=(new jp(a.g)).a.N().b.V(),new pp(e));_n(c.a.a);){b=(d=is(c.a),d.S());b.g=(g=bj(b.b*Ct(b)*100/f*Sw),g/Sw)}}
function Ru(a){var b,c,d,e,f;if(a.e)throw Xg(new iv(tx));f=0;for(c=(e=(new jp(a.g)).a.N().b.V(),new pp(e));_n(c.a.a);){b=(d=is(c.a),d.S());f+=b.f*Ct(b)}return f}
function Cu(a){var b,c,d;if(a.c)throw Xg(new iv(qx));if(a.e)throw Xg(new iv(rx));d=0;for(c=new bq(a.d);c.a<c.c.a.length;){b=aq(c);d=De(d+Ru(b)*b.f)}return d}
...
function gu(a){var b,c,d,e,f;if(qn(a.b)==0){return}e=0;for(d=(f=(new zo(a.b)).a.N().K(),new Eo(f));d.a.O();){c=(b=d.a.P(),b.T());e+=c.b*c.d/100}if(e==0)return;a.c=e}
function Tu(a){var b,c,d,e,f;if(a.g.d==0)return '';f=new Gj('');for(c=(e=(new jp(a.g)).a.N().b.V(),new pp(e));_n(c.a.a);){b=(d=is(c.a),d.S());Ej(f,Et(b))}return f.a}
...
function Bu(a){var b,c,d,e;if(a.c)throw Xg(new iv(qx));if(a.e)throw Xg(new iv(rx));b=0;for(d=new bq(a.d);d.a<d.c.a.length;){c=aq(d);b+=Qu(c)*c.f}return e=bj(b*Tw),e/Tw}
function Du(a,b){var c,d,e,f;if(a.c)throw Xg(new iv(ox));if(a.e)throw Xg(new iv(px));f=0;for(d=new bq(a.d);d.a<d.c.a.length;){c=aq(d);f+=nt(Jv(c,b))*c.f}return e=bj(f*Tw),e/Tw}
function zu(a){var b,c,d,e;if(a.e)throw Xg(new iv('The charge is not clearly defined'));b=0;for(d=new bq(a.d);d.a<d.c.a.length;){c=aq(d);b+=c.a*c.f}return e=bj(b*Tw),e/Tw}
function Qu(a){var b,c,d,e,f,g;if(a.e)throw Xg(new iv(tx));f=0;for(c=(e=(new jp(a.g)).a.N().b.V(),new pp(e));_n(c.a.a);){b=(d=is(c.a),d.S());f+=b.e*Ct(b)}return g=bj(f*Tw),g/Tw}
...
function Xv(a,b,c){var d,e;for(d=0;d<a.a.a.length;d++){for(e=d+1;e<a.a.a.length;e++){b[d]=b[d]+su((lr(e,a.a.a.length),yp(a.a,e)));c[d]=c[d]+ru((lr(e,a.a.a.length),yp(a.a,e)))}}}
...
function Au(a){var b,c,d,e;if(a.c)throw Xg(new iv(qx));if(a.e)throw Xg(new iv('The mass is not defined'));d=0;for(c=new bq(a.d);c.a<c.c.a.length;){b=aq(c);d+=Pu(b)*b.f}return e=bj(d*Sw),e/Sw}
...
function $t(a){var b,c,d,e,f,g,h;e=a.d;e>(a.a/2|0)&&(e=a.a/2|0);f='';d=(new ps(a)).b.V();b=0;while(_n(d.a)&&b<e){++b;c=d.b=ao(d.a);g=nt(c.S());h=nt(c.T());h>-1.0E100&&(f+=g+', '+h+ix)}return f}
function _t(a){var b,c,d,e,f,g,h;e=a.d;e>(a.a/2|0)&&(e=a.a/2|0);f=new Fj;d=(new ps(a)).b.V();b=0;while(_n(d.a)&&b<e){++b;c=d.b=ao(d.a);g=nt(c.S());h=nt(c.T());Ej(f,Yt(g)+', '+Yt(h*100)+ix)}return f}
function Xt(a){var b,c,d,e,f,g,h;g=a.a/2|0;if(a.d<g)return;h=new Ms(new du);sm(h,new ps(a));e=0;for(f=(d=(new jp(h.g)).a.N().b.V(),new pp(d));_n(f.a.a);){c=(b=is(f.a),b.S());e++>g&&Ur(a,c.S())}}
function Mu(a,b){var c;if(b.c<b.d)throw Xg(new iv('Syntax error: maxCount<minCount'));c=Ou(a,b.i);if(c)if(c.a==b.a){c.d+=b.d;c.c+=b.c;return}b.c==0&&b.d==0&&(a.e=true);Tr(a.g,b,(Th(),Sh))==null}
...
function _u(b){var c,d;d=new kw;jw(d,'name',b.c);jw(d,'symbol',b.b);jw(d,wx,Uu(b.a));try{hw(d,'mass',new Uc(Pu(b.a)))}catch(a){a=Wg(a);if(we(a,4)){c=a;ob(c,(Sj(),Qj),'')}else throw Xg(a)}return d}
function Qt(a,b){var c,d,e,f,g,h;e=new bu;d=(new ps(a)).b.V();while(_n(d.a)){f=d.b=ao(d.a);g=nt(f.S());h=nt(f.T());g=bj(g/b)*b;c=Um(e.W(g));c!=null&&(h+=(ht(c),c));Tr(e,g,h)}a.c=null;a.d=0;Ot(a,e)}
...
function Wt(a,b){var c,d,e,f,g;c=hx;d=(new ps(a)).b.V();while(_n(d.a)){e=d.b=ao(d.a);e.S();g=nt(e.T());g>c&&(c=g)}d=(new ps(a)).b.V();while(_n(d.a)){e=d.b=ao(d.a);f=e.S();g=e.T();Tr(a,f,(ht(g),g)/c*b)}}
function Hu(a){var b,c,d;c=new bq(a.d);d=new Gj('');c.a<c.c.a.length&&(d=new Gj(Gh(aq(c))));while(c.a<c.c.a.length){b=aq(c);b.f==1?Ej(d,'.'+Uu(b)):b.f==0?Ej(d,'.n'+Uu(b)):Ej(d,'.'+b.f+Uu(b))}return d.a}
...
function Su(a){var b,c,d,e,f;if(a.e)throw Xg(new iv('Cannot get the number of atoms: this is a range formula'));f=0;for(c=(e=(new jp(a.g)).a.N().b.V(),new pp(e));_n(c.a.a);){b=(d=is(c.a),d.S());f+=Ct(b)}return f}
function Pu(a){var b,c,d,e,f,g;if(a.e)throw Xg(new iv('Cannot calculate mass of a range formula'));f=0;for(c=(e=(new jp(a.g)).a.N().b.V(),new pp(e));_n(c.a.a);){b=(d=is(c.a),d.S());f+=b.b*Ct(b)}return g=bj(f*Sw),g/Sw}
...
function Uu(a){var b,c,d,e,f;if(a.g.d==0)return '';f=new Gj('');for(c=(e=(new jp(a.g)).a.N().b.V(),new pp(e));_n(c.a.a);){b=(d=is(c.a),d.S());Ej(f,Ft(b,a.c))}a.a!=0&&(a.a>0?Ej(f,'(+'+a.a+')'):Ej(f,'('+a.a+')'));return f.a}
...
function _v(b,c){var d,e,f,g,h;h=new gr;try{for(e=(g=(new jp(b.g)).a.N().b.V(),new pp(g));_n(e.a.a);){d=(f=is(e.a),f.S());d.c=aj(d.c,De(c/d.e));if(d.d>d.c)return null;fr(h,new uu(d))}Fp(h.a)}catch(a){a=Wg(a);if(!we(a,4))throw Xg(a)}return h}
function Gu(b){var c,d,e;e=wj(b,'/');if(e.length!=2)throw Xg(new iv(sx+b));try{c=Bi(e[1]);if(c==0)throw Xg(new iv('Syntax error: divide by zero: '+b));d=Bi(e[0]);return d/c}catch(a){a=Wg(a);if(we(a,21)){throw Xg(new iv(sx+b))}else throw Xg(a)}}
function au(a){var b,c,d,e,f,g,h;e=a.d;e>(a.a/2|0)&&(e=a.a/2|0);f=Cd(Ge,[pw,Qw],[32,7],15,[e,2],2);b=0;for(h=(d=(new jp(a)).a.N().b.V(),new pp(d));_n(h.a.a);){g=(c=is(h.a),c.S());f[b][0]=(ht(g),g);f[b][1]=nt(Um(Kr(a,g)));++b;if(b==e)break}return f}
function Rt(a,b){var c,d,e,f,g,h,i;d=new bu;c=(new ps(a)).b.V();if(!_n(c.a)){return}e=gx;f=0;while(_n(c.a)){g=c.b=ao(c.a);h=nt(g.S());i=nt(g.T());if(h-e>b){e!=gx&&Tr(d,e,f);e=h;f=i}else{e=(e*f+h*i)/(f+i);f+=i}}e!=gx&&Tr(d,e,f);a.c=null;a.d=0;Ot(a,d)}
function hv(b){gv();var c,d,e,f,g;if(b==null)return fv;g=wj(b,' *, *');for(e=0;e<g.length;e++){f=g[e];d=vj(f,' *:.*','');c=vj(f,'.*: *','');if(!oj(d,'')&&!oj(c,'')){try{nn(fv,d,new av(d,d,c,ev,fv))}catch(a){a=Wg(a);if(!we(a,4))throw Xg(a)}}}return fv}
...
function ku(a){var b,c,d,e,f;f='Element: '+a.a+lx+a.g+' - exact mass: '+a.d+mx+a.c+' - name: '+a.e+' - nb isotope: '+qn(a.b)+ix;for(d=(e=(new zo(a.b)).a.N().K(),new Eo(e));d.a.O();){c=(b=d.a.P(),b.T());f+='Number: '+c.c+mx+c.b+nx+c.d+lx+c.a+ix}return f}
...
function It(a,b,c,d){var e;if(c>d)throw Xg(new iv(fx));if(b==0){this.d=c;this.c=d;this.e=iu(a);this.f=a.f;this.a=0;this.i=a.g;this.b=a.c;return}e=jn(a.b,new Pi(b));if(!e)throw Xg(new iv('Isotope not found'));this.a=b;this.i=a.g;this.b=e.b;this.e=e.b;this.d=c;this.c=d}
...
function av(b,c,d,e,f){var g;this.b=b;this.c=c;try{this.a=new Vu(d,e,f)}catch(a){a=Wg(a);if(we(a,8)){g=a;Sj();"Group creation error: '"+b+"'='"+d+"': "+rb(g,g.s());this.a=new Vu('',e,f)}else throw Xg(a)}if(this.a.e)throw Xg(new iv('Range formulas not allowed for groups'))}
...
function hu(a){var b,c,d,e,f,g,h;if(qn(a.b)==0){a.d=a.c;a.f=sh(dh($wnd.Math.round(a.c)));return}b=1.7976931348623157E308;h=hx;d=true;for(f=(g=(new zo(a.b)).a.N().K(),new Eo(g));f.a.O();){e=(c=f.a.P(),c.T());if(e.d>h||d){d=false;b=e.b;h=e.d}}a.d=b;a.f=sh(dh($wnd.Math.round(b)))}
...
function nu(a,b,c){var d,e,f,g,h,i,j,k,l;this.e=c;this.g=b;this.a=a.a;this.b=new xq;h=vj(c,'[^0-9,\\.]','');k=wj(h,',');e=0;for(g=(j=(new zo(a.b)).a.N().K(),new Eo(j));g.a.O();){f=(d=g.a.P(),d.T());l=0;k.length>e&&(l=Ai(k[e]));i=new bv(f.c,f.b,l,f.a);mn(this.b,Xi(f.c),i);++e}gu(this);hu(this)}
...
function kv(a){var b,c,d,e,f;c=true;for(e=new bq(a.d.d);e.a<e.c.a.length;){d=aq(e);if(c){a.e=new Av(a,d,a.c);Vt(a.e.c,d.f);b=a.e;c=false}else{b=new Av(a,d,a.c);Vt(b.c,d.f);Ot(a.e.c,b.c)}if(d.b!=''){f=Tt(b.c);fn(a.g,f)?mn(a.g,f,jn(a.g,f)+','+d.b):mn(a.g,f,d.b)}}if(a.e.c.d==0)throw Xg(new iv('Isotopic distribution: empty table'))}
...
function ju(a){var b,c,d,e,f,g,h,i;e=new kw;jw(e,'symbol',a.g);hw(e,jx,new Uc(a.d));hw(e,'mass',new Uc(a.c));jw(e,'name',a.e);hw(e,'atomicNumber',new Uc(a.a));g=new ew;hw(e,'isotopes',g.a);for(d=(h=(new zo(a.b)).a.N().K(),new Eo(h));d.a.O();){c=(b=d.a.P(),b.T());f=(i=new kw,hw(i,'mass',new Uc(c.b)),hw(i,kx,new Uc(c.d)),i);dw(g,f.a)}return e}
...
function $u(a,b,c,d){var e,f,g,h,i,j,k,l,m;if(b.indexOf(',')==-1)throw Xg(new iv('Syntax error: combinatorial'));if(c!=d)throw Xg(new iv('Combinatorial range formulae are not allowed'));j=wj(b,',');i=0;h=j.length;m=new Gj('{');for(g=0;g<h-1;g++){l=zj(j[g]);f=new Vu(l,a.c,a.d);Ej(m,Tu(f)+',');i+=Pu(f)}k=zj(j[h-1]);e=new Vu(k,a.c,a.d);Ej(m,Tu(e)+'}');i+=Pu(e);i/=h;Mu(a,new Gt(m.a,i,c,d))}
...
function Vv(b,c,d){var e,f,g,h,i,j,k,l,m,n;j=new kw;n=b.b.a.get(Cx);if(n!=null&&!oj(n,'')){try{d=(gv(),gv(),ev)}catch(a){a=Wg(a);if(!we(a,47))throw Xg(a)}}if(d){k=new ew;hw(j,'elements',k.a);for(f=(m=(new zo(d)).a.N().K(),new Eo(m));f.a.O();){e=(g=f.a.P(),g.T());dw(k,ju(e).a)}}if(c){l=new ew;hw(j,Bx,l.a);for(i=(m=(new zo(c)).a.N().K(),new Eo(m));i.a.O();){h=(g=i.a.P(),g.T());dw(l,_u(h).a)}}return j}
...
function mv(b){var c,d,e;if(b.e.c.d==0)throw Xg(new Ab(yx));Tr(b.e.c,nt(cp(Lr(b.e.c)))-2,0);Tr(b.e.c,nt(cp(Mr(b.e.c)))+2,0);d=new xq;nn(d,'FWHM',b.b+'');nn(d,'Threshold',b.a+'');try{if(b.d.d.a.length==1){e=yp(b.d.d,0);nn(d,'Monoisotopic mass',Qu(e)+'');nn(d,'Molecular weight',Pu(e)+'');Jv(e,null)!=null&&nn(d,'Unsaturation',Jv(e,null)+'')}}catch(a){a=Wg(a);if(we(a,8)){c=a;ob(c,(Sj(),Rj),'')}else throw Xg(a)}return Zt(b.e.c,b.d+' - fwhm: '+b.b,b.g,d)}
...
function xu(a){var b,c,d,e,f,g,h,i,j,k,l,m;if(a.c)throw Xg(new iv(ox));if(a.e)throw Xg(new iv(px));e=new xq;for(i=new bq(a.d);i.a<i.c.a.length;){h=aq(i);for(d=(g=(new jp(h.g)).a.N().b.V(),new pp(g));_n(d.a.a);){b=(f=is(d.a),f.S());if(ln(e,b.i)){k=kn(e,b.i);k.d=De(k.d+b.d*h.f);k.c=De(k.c+b.c*h.f)}else{k=new Ht(b);k.d=De(k.d*h.f);k.c=De(k.c*h.f);nn(e,b.i,k)}}}j=Au(a);for(c=(l=(new zo(e)).a.N().K(),new Eo(l));c.a.O();){b=(f=c.a.P(),f.T());b.g=(m=bj(b.b*Ct(b)*100/j*Sw),m/Sw)}return new zo(e)}
...
function Lu(b,c,d,e,f,g){var h,i,j,k,l,m,n,o;if(oj(c,'Zcharge')){b.a+=d;return}if(c.charCodeAt(0)==91){h=1;while($h(c.charCodeAt(h)))++h;if(f==0){try{f=Bi(c.substr(1,h-1))}catch(a){a=Wg(a);if(we(a,8)){throw Xg(new iv('Bad isotope syntax'))}else throw Xg(a)}}c=yj(c,h,c.length-1)}i=kn(b.c,c);if(!i){n=kn(b.d,c);if(!n)throw Xg(new iv('Unrecognized symbol: '+c));if(f!=0)throw Xg(new iv('Syntax error: cannot specify isotopes for groups'));if(g){m=(k=(new jp(n.a.g)).a.N().b.V(),new pp(k));while(_n(m.a.a)){l=(j=is(m.a),j.S());o=new Ht(l);o.d*=d;o.c*=e;Mu(b,o)}}else{Mu(b,new Jt(n,d,e))}}else{Mu(b,new It(i,f,d,e))}}
...
function sv(a,b){var c,d,e,f,g,h,i,j,k,l,m,n,o,p;p=new Xu(new Cv(a));sm(p,b);m=1;for(e=(k=(new jp(p.g)).a.N().b.V(),new pp(k));_n(e.a.a);){c=(i=is(e.a),i.S());h=kn(a.a,c.i);qn(h.b)>m&&(m=qn(h.b))}n=2*m*$wnd.Math.log(Su(p)+1)/$wnd.Math.log(2);o=a.d.b/(n*4);xv(a,o);Tr(a.c,0,1);for(d=(j=(new jp(p.g)).a.N().b.V(),new pp(j));_n(d.a.a);){c=(i=is(d.a),i.S());h=kn(a.a,c.i);if(c.a!=0){f=new lu(c.b,c.b,h.g,h.e,h.a);h=f}if(qn(h.b)==0){l=new bv(De(h.c+0.5),h.c,1,h.g);mn(h.b,new Pi(l.c),l)}if(Ct(c)<0){throw Xg(new iv('Number of element under 0'))}else if(Ct(c)==0);else if(Ct(c)==1){a.c=tv(a,new zv(a.d,h,a.a))}else{g=new zv(a.d,h,a.a);xv(g,a.b);a.c=tv(a,rv(g,Ct(c)))}}}
...
function Fu(a,b,c){var d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,A,B;b=vj(b,' ','');(new $wnd.RegExp('^(.*[a-zA-Z][0-9]+-[0-9].*)$')).test(b)&&(a.c=true);r=new RegExp('([A-Z][a-z]?\\{[0-9.,]*\\})');for(t=r.exec(b);t;t=r.exec(b)){h=t[1];p=(v=yu(h),w=vj(h,'\\{.*',''),gn(a.a,v)||nn(a.a,v,new nu(kn(a.a,w),v,h)),v);b=b.replace(r,p)}r=new RegExp('(\\{[A-Za-z0-9]*\\})');for(s=r.exec(b);s;s=r.exec(b)){h=s[1];q=(A=yu(h),B=vj(h,'[\\{\\}]',''),gn(a.b,A)||nn(a.b,A,new av(A,h,B,a.a,a.b)),A);b=b.replace(r,q)}b.indexOf('}')!=-1;g=wj(b,'\\.');n=1;o=false;for(e=0,f=g.length;e<f;++e){d=g[e];if(Eu(d)){if(o)throw Xg(new iv("Syntax error: 'number.number.'"));n=Ai(d);o=true;continue}u=d.indexOf('/');if(u!=-1){if(o)throw Xg(new iv("Syntax error: 'number.number/number'"));k=u+1;l=d.length;while($h(lj(d,k++))){if(k>=l)break}k<l&&--k;n=Gu(d.substr(0,k));o=true;if(k>=l)continue;else d=d.substr(k,d.length-k)}j=0;for(;j<d.length;j++){if(!$h(d.charCodeAt(j)))break}if(j>0){m=Ai(d.substr(0,j));d=d.substr(j,d.length-j);o?(n+=m/$wnd.Math.pow(10,j)):(n=m)}i=new Wu(d,a.a,a.b,n,c);i.f==0&&(a.e=true);i.e&&(a.c=true);vp(a.d,i);n=1;o=false}}
...
function Zt(a,b,c,d){var e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,A;u=new Fj;t=a.d;t>(a.a/2|0)&&(t=a.a/2|0);u.a+='##TITLE= '+b+ix+'##JCAMP-DX= 5.00\r\n'+'##DATA TYPE= MASS SPECTRUM\r\n'+'##DATA CLASS= PEAK TABLE\r\n'+'##ORIGIN= Generated spectrum based on ChemCalc www.chemcalc.org\r\n'+'##SPECTROMETER/DATA SYSTEM= Based on ChemCalc isotopic distribution calculator\r\n'+'##XUNITS= M/Z\r\n'+'##YUNITS= RELATIVE ABUNDANCE\r\n'+'##NPOINTS=         \r\n';e=u.a.length;u.a+='##MAXY= 100\r\n##MINY= 0\r\n';for(n=(q=(new po(d)).a.N().K(),new vo(q));n.a.O();){m=(h=n.a.P(),h.S());Ej(u,'##$'+m+'='+(m==null?Um(Aq(d.a,null)):Qq(d.b,m))+ix)}u.a+='##PEAK TABLE= (XY..XY)\r\n';p=0;l=(new ps(a)).b.V();o=wm(new po(c),Ed(ff,{3:1,144:1},72,(new po(c)).a.size(),7,1));iq(o,0,o.length,null);g=0;r=hx;j=true;f=0;s=false;A='';while(_n(l.a)&&f<t){++f;h=l.b=ao(l.a);v=nt(h.S());w=nt(h.T());w<1.0E-9&&(w=0);if(w!=0&&A.length>0){u.a+=A;++p;A=''}i=true;for(k=g;k<o.length;k++){if(!_n(l.a)||$wnd.Math.abs(nt(o[k])-r)<$wnd.Math.abs(nt(o[k])-v)){if(i){u.a+='  $$ ';i=false}else{u.a+=','}Ej(u,jn(c,o[k]));++g}else{break}}r=v;if(j){j=false;Ej(u,Yt(v)+', '+Yt(w*100));++p}else{if(!s||w!=0){u.a+=ix;Ej(u,Yt(v)+', '+Yt(w*100));++p}else{A=ix+Yt(v)+', '+Yt(0)}w==0?(s=true):(s=false)}}u.a+='\r\n##END=\r\n';u.a=yj(u.a,0,e-10)+(p+'')+xj(u.a,e-2);return u}
