...
function xt(a,b,c,d,e){var f,g,h,i,j,k,l;as.call(this);this.f=b;this.g=c;this.k=d;h=a.indexOf('$');if(h>-1){this.e=Yj(a,h+1,a.length-(h+1));a=a.substr(0,h)}g=new RegExp('([A-Z][a-z]?\\{[0-9.,]*\\})');for(j=g.exec(a);j;j=g.exec(a)){f=j[0];this.d+=Ri(Rj(Rj(Rj(Rj(f,'[^0-9+-]',''),'-$','-1'),'[+]$','1'),'^[+]',''));a=a.replace(g,'')}g=new RegExp('(\\([0-9]+[+-]\\))');for(k=g.exec(a);k;k=g.exec(a)){f=k[0];this.d+=Ri(Rj(Rj(Rj(f,'[^0-9+-]',''),'^([0-9])([+-])$','$2$1'),'^[+]',''));a=a.replace(g,'')}g=new RegExp('(\\([+-][0-9]+\\))');for(l=g.exec(a);l;l=g.exec(a)){f=l[0];this.d+=Ri(Rj(Rj(Rj(f,'[^0-9+-]',''),'^([0-9])([+-])$','$1$2'),'^[+]',''));a=a.replace(g,'')}g=new RegExp('([+-])(?![0-9])');for(i=g.exec(a);i;i=g.exec(a)){f=i[0];Lj(f,'+')?++this.d:--this.d;a=a.replace(g,'')}Qj(a,'[a-zA-Z][0-9]+-[0-9]')&&(this.j=true);a.indexOf('}')!=-1;At(this,a,e)}
